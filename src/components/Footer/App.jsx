          ...
          <div>
            ...
            <p className="block text-1xl font-semibold text-gray-100 ">
             Social Media
              ...
              <li>
                <a
                  href="https://www.linkedin.com/in/shubhendu-halder-5752762ba/"
                  target="_blank"
                  rel="noreferrer"
                  className="text-gray-400 transition duration-300 hover:text-gray-300"
                  aria-label="LinkedIn"
              ...
              <li>
                <a
                  href="https://www.instagram.com/whoami4274/"
                  target="_blank"
                  rel="noreferrer"
                  className="text-gray-400 transition duration-300 hover:text-gray-300"
        ...
        <div className="mt-12 border-t border-gray-800 pt-12">
          <div className="flex flex-col items-center sm:flex-row sm:justify-between">
            <p className="mt-8 text-xs text-gray-500">
              &copy; {new Date().getFullYear()} PORTFOLIO/SHUBHENDU HALDER. All rights reserved.
            </p>
          </div>
        </div>
      </div>

...
import image from "../../assets/py.png";
import image1 from "../../assets/leetcode.png";
import image2 from "../../assets/problemSolve.png";
...
import image9 from "../../assets/collage2.png";
import image10 from "../../assets/early2.png";
...
export function TimelineDemo() {
  ...
  return (
    (<div className="w-full bg-[#0a0a0a]">
      <TextHoverEffect text="JOURNEY" id="time"/>
      <Timeline data={data} />
    </div>)
  );
}